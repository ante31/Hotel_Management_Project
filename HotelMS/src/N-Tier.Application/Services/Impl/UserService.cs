...
using HotelMS.Application.Exceptions;
using HotelMS.Application.Helpers;
using HotelMS.Application.Models;
using HotelMS.Application.Models.User;
using HotelMS.Application.Templates;
...
public class UserService : IUserService
{
    ...
    public async Task<UserResponseModel> GetById(string id)
    {
        ...
        var userRes = _mapper.Map<UserResponseModel>(user);
